        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <button
              ...
              className="inline-flex items-center cursor-pointer gap-2 text-sm text-white/50 hover:text-white transition-colors"
            >
              ...
              {[
                ...
                <li key={item.label}>
                  <button
                    ...
                    className="text-sm cursor-pointer text-white/50 hover:text-white transition-colors"
                  >
                    {item.label}
                  </button>
                </li>
